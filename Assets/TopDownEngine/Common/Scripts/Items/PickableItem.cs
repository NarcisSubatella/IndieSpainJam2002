...
namespace MoreMountains.TopDownEngine
{
	...
	public class PickableItem : MonoBehaviour
	{
        ...
        {
			this._pickable = true;
			this.redyThrow = false;
		}private void ThrowRedy()
        {
			this.redyThrow = true;
		}
        /// <summary>
		...
		private void DropPreviosItem(GameObject previosGO)
		{
			previosGO.SetActive(true);
			previosGO.GetComponent<Collider2D>().enabled = true;
			previosGO.transform.SetParent(null);

		}
		private void DropCurrentItem(GameObject current)
		{
			current.GetComponent<Character>().objectGraping = null;
